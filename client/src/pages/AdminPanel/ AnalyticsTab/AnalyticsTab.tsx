...
import {OrderSalesOverTime, TotalProductsByCategory} from "../../../DataModel/Objects/Analytics";
...
export const AnalyticsTab: React.FC = () => {
  ...
  const [totalProductsByCategory, setTotalProductsByCategory] = useState<Array<TotalProductsByCategory>>();
  const [salesOverTime, setSalesOverTime] = useState<Array<OrderSalesOverTime>>();
  ...
  const fetchAnalyticsData = () => {
    ...
    Promise
        .all([getTotalProductsByCategoryRequest(null), getSalesOverTimeRequest(null)])
  ...
  if (isLoading) {
    ...
    return (
        <div style={{height: "100%", display: "flex", flexDirection: "column", paddingBlock: "16px", paddingInline: "32px"}}>
            <div style={{
                    display: "flex",
                    alignItems: "center",
            ...
            {isLoadingAnalytics ? (
                ...
                <div>
                    <TotalProductsByCategoryChart data={totalProductsByCategory as TotalProductsByCategory[]}/>
                    <OrderSalesOverTimeChart data={salesOverTime as OrderSalesOverTime[]}/>
                </div>
            )}
        </div>
    );
